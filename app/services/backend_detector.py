...
class BackendDetector:
    def detect_backend(self, hwnd: int, backend: str) -> BackendResult:
        ...
        try:
            ...
            result.control_type_counts = dict(type_counts)
            result.has_edit = bool(type_counts.get("Edit"))
            result.has_tree = bool(type_counts.get("Tree"))
            result.has_table = bool(type_counts.get("Table"))
            result.has_list = bool(type_counts.get("List"))
            result.has_tab = bool(type_counts.get("Tab"))
            result.has_button = bool(type_counts.get("Button"))
            result.has_datagrid = bool(type_counts.get("DataGrid"))
            result.has_custom = bool(type_counts.get("Custom"))
